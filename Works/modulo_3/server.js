...
server.get("/", (request, response) => {
    const data = {
        ...
        role: "2º dan - Aikikai",
        description: 'Professor da escola de Aikido Kyoukai Recife. Felipe Ferreira sensei é graduado 2º dan pela Aikikai e é aluno do Leonardo Sodré sensei, 5º dan Aikikai. Filiação: <a href="https://aikidopesquisa.wordpress.com" target="_blank">APA</a>',
        links: [
